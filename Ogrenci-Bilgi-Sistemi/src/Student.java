public class Student {
    ...
    public void calcAvarage() {
        this.avarage = (((this.fizik.note + this.kimya.note + this.mat.note) * 0.80) + ((this.fizik.sozluNote + this.kimya.sozluNote + this.mat.sozluNote) * 0.60)) / 3 ;
    }
    ...
    public void printNote(){
        ...
        System.out.println("Fizik Sözlü Notu : " + this.kimya.sozluNote);
    }
